...
#Region "Filter"
    ...
    Public Sub SetFilter()
        Try
            ...
            objFilter.AddEx(frm_SalesQuotation)
        ...
        Try
            Select Case EventType
                Case SAPbouiCOM.BoAppEventTypes.aet_ShutDown, SAPbouiCOM.BoAppEventTypes.aet_ServerTerminition, SAPbouiCOM.BoAppEventTypes.aet_CompanyChanged
                    ...
                    oApplication.Utilities.Message("Quantity Calculation Addon Disconnected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                    CloseApp()
            End Select
        Catch ex As Exception
