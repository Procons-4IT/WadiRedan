Public Module modVariables
    ...
    Public Const xml_DupSales As String = "frm_DupSales.xml"
    Public Const mnu_DupSales As String = "Z_DupSales"
    Public Const frm_DupSales As String = "frm_DupSales"
    ...
    Public Const frm_SalesQuotation As String = "149"
