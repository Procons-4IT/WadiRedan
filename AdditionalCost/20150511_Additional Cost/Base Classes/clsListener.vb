...
#Region "Menu Event"
    ...
    Private Sub _SBO_Application_FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean) Handles _SBO_Application.FormDataEvent
        ...
        Select Case BusinessObjectInfo.FormTypeEx
            Case frm_Order, frm_Delivery, frm_Invoice
        ...
        Try
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    ...
                    Case mnu_DupSales
                        oMenuObject = New clsDupSalesOrder
                ...
                Select Case pVal.FormTypeEx
                    Case frm_DupSales
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsDupSalesOrder
                    ...
                    Case frm_AvCheck
                        If Not _Collection.ContainsKey(FormUID) Then
                            ...
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_Order, frm_Delivery, frm_Invoice, frm_ARDownpayment, frm_ResInvoice, frm_SalesQuotation
                        If Not _Collection.ContainsKey(FormUID) Then
        ...
        Try
            Select Case EventType
                Case SAPbouiCOM.BoAppEventTypes.aet_ShutDown, SAPbouiCOM.BoAppEventTypes.aet_ServerTerminition, SAPbouiCOM.BoAppEventTypes.aet_CompanyChanged
                    ...
                    oApplication.Utilities.Message("Crew Breifing Sheet Addon Disconnected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                    CloseApp()
            End Select
        Catch ex As Exception
