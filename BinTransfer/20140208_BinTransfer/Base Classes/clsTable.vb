...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "ORDR" Or strTab = "INV1" Or strTab = "OWTR" Or strTab = "OITM" Or strTab = "RDR1") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddFields("RDR1", "Z_FromBin", "From Bin Location", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("RDR1", "Z_ITNO", "Inventory Transfer Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            addField("OITM", "Z_BinTransfer", "Automatic Bin Transfer", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
