Public Class clsAvailabiltyCheck
    ...
    Public Sub LoadForm(ByVal aDate As String, ByVal aTime As String)
        ...
        Try
            ...
            strquery = "select  X.U_Z_PumpCode,x.U_Z_PumpName, x.DocNum,X.CardCode,x.CardName,x.DocDueDate,x.U_Z_FromTime,x.U_Z_ToTime,X.Dscription,X.U_Z_LOCATION,X.U_Z_Type,X.WhsCode,x.Quantity from "
            ...
            oGrid.Columns.Item(2).TitleObject.Caption = "Document Number"
            oGrid.Columns.Item(3).TitleObject.Caption = "Customer Code"
            oEditTextColumn = oGrid.Columns.Item(3)
            oEditTextColumn.LinkedObjectType = "2"
            oGrid.Columns.Item(4).TitleObject.Caption = "Customer Name"
            oGrid.Columns.Item(5).TitleObject.Caption = "Delivery Date"
            oGrid.Columns.Item(6).TitleObject.Caption = "From Time"
            oGrid.Columns.Item(7).TitleObject.Caption = "To Time"
