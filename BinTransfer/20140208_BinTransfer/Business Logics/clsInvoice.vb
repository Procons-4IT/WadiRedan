...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If 1 = 2 Then ' pVal.FormTypeEx = frm_Order Or pVal.FormTypeEx = frm_Delivery Or pVal.FormTypeEx = frm_Invoice Or pVal.FormTypeEx = frm_ARDownpayment Or pVal.FormTypeEx = frm_ResInvoice Then
                    ...
                    If pVal.BeforeAction = False Then
                        If oForm.TypeEx = frm_Order Then
                            If oApplication.Utilities.getEdittextvalue(oForm, "12") <> "" Then
                                ...
                                objct.LoadForm(dtDate.ToString("dd-MM-yyyy"), ItemName)
                            Else
            ...
            If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True And (BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD Or BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE) Then
                If BusinessObjectInfo.FormTypeEx = frm_Delivery Then
                    ...
                    If oobj.Browser.GetByKeys(BusinessObjectInfo.ObjectKey) Then
                        For intRow As Integer = 0 To oobj.Lines.Count - 1
                            oobj.Lines.SetCurrentLine(intRow)
                            If oobj.Lines.UserFields.Fields.Item("U_Z_FromBin").Value <> "" And oobj.Lines.UserFields.Fields.Item("U_Z_ITNO").Value = "" Then
                                Try
                                    oApplication.Utilities.createInventoryTransfer(oobj.DocEntry, oobj.DocDate, oobj.Lines.ItemCode, oobj.Lines.WarehouseCode, oobj.Lines.UserFields.Fields.Item("U_Z_FromBin").Value, oobj.Lines.Quantity, oobj.DocNum, oobj.Lines.LineNum)
                                Catch ex As Exception
