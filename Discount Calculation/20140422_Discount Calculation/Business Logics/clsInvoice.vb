...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Order Or pVal.FormTypeEx = frm_Delivery Or pVal.FormTypeEx = frm_Invoice Or pVal.FormTypeEx = frm_ARDownpayment Or pVal.FormTypeEx = frm_ResInvoice Then
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_LOST_FOCUS
                                ...
                                'End If
                                'If pVal.ItemUID = "38" And (pVal.ColUID = "U_Z_PALLET" Or pVal.ColUID = "U_Z_LAYER" Or pVal.ColUID = "U_Z_ECH") Then
                                '    oApplication.Utilities.CalculateQTY(oForm, pVal.Row)
                                'End If
                                'If pVal.ItemUID = "38" And (pVal.ColUID = "U_Z_DISCOUNT" Or pVal.ColUID = "U_TotalDis") Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                '    oApplication.Utilities.CalculatePallet(oForm, pVal.Row)
                                '    oApplication.Utilities.CalculateDiscount(oForm, pVal.Row, "U_Z_DISCOUNT")
                                'End If
